...
export const comparisonPages: ComparisonPageAttributes[] = [
  {
    ...
    dateModified: null,
    verdict: "Candy AI is a solid choice with a large community and competitive pricing. But MyDreamGirlfriend.ai offers something Candy AI doesn't — depth. Natural relationship deepening with persistent memory, deeper personality customization, and end-to-end encryption create a more immersive experience. If you want instant everything, Candy AI works. If you want a relationship that feels earned and real, MyDreamGirlfriend.ai is the better choice.",
    features: [
      { feature: 'Relationship Progression', us: 'Natural deepening with persistent memory', them: 'No progression system', winner: 'us' },
      ...
      { feature: 'AI Photos', us: 'Yes — unlocked with gems', them: 'Yes — available immediately', winner: 'tie' },
      { feature: 'Voice Features', us: 'Unique voice per character, voice notes', them: 'Voice messages available', winner: 'tie' },
      { feature: 'NSFW Content', us: 'Uncensored', them: 'Uncensored from start', winner: 'tie' },
      ...
      { feature: 'Pricing', us: 'Free, Premium from $3.99/mo', them: 'From $5.99/mo', winner: 'us' },
    ...
    faqs: [
      ...
      { question: 'Does MyDreamGirlfriend have a free plan like Candy AI?', answer: 'Yes. MyDreamGirlfriend.ai offers a free plan with 15 messages/day, 1 girlfriend, and access to all pre-built characters. No credit card required.' },
      { question: 'Which has better NSFW content?', answer: 'Both offer uncensored content. Candy AI provides it immediately. MyDreamGirlfriend lets it unlock naturally as your relationship deepens, creating anticipation and a more meaningful experience.' },
  ...
  },
  {
    ...
    datePublished: '2026-03-01',
    dateModified: null,
    verdict: "Replika excels at emotional companionship and has the best free tier in the market. But it's firmly SFW, offers no image generation, and has limited customization. MyDreamGirlfriend.ai provides the full AI girlfriend experience — uncensored conversations, AI photos, voice notes, deep customization, and a relationship that deepens naturally with persistent memory. If you want a supportive friend, Replika is great. If you want a girlfriend, MyDreamGirlfriend.ai delivers.",
    features: [
      { feature: 'Relationship Progression', us: 'Natural deepening with persistent memory', them: 'Basic relationship levels', winner: 'us' },
      ...
      { feature: 'NSFW Content', us: 'Uncensored', them: 'Strictly filtered', winner: 'us' },
      { feature: 'Privacy', us: 'End-to-end encryption', them: 'Strong privacy policy', winner: 'tie' },
      { feature: 'Free Tier', us: '15 messages/day', them: 'Unlimited messages', winner: 'them' },
      { feature: 'Pricing', us: 'Free, Premium from $3.99/mo', them: '$19.99/mo (Pro)', winner: 'us' },
    ...
    faqs: [
      ...
      { question: 'Does Replika allow NSFW content?', answer: 'No. Replika has strict content filters and does not allow romantic or NSFW interactions on its platform. MyDreamGirlfriend.ai offers fully uncensored content.' },
      { question: 'Which has better conversation quality?', answer: 'Both are strong. Replika excels at emotional intelligence and support. MyDreamGirlfriend.ai offers more varied conversation styles thanks to deep personality customization and persistent memory.' },
      { question: 'Can I get AI photos on Replika?', answer: 'No. Replika does not offer AI image generation. MyDreamGirlfriend.ai generates unique photos from your AI girlfriend as your relationship deepens.' },
      { question: "Is MyDreamGirlfriend cheaper than Replika Pro?", answer: "Yes. MyDreamGirlfriend Premium starts from $3.99/mo — a fraction of Replika Pro ($19.99/mo) — and includes unlimited messages, 100 gems/month, and the full AI girlfriend experience." },
    ],
  },
  {
    slug: 'character-ai',
    ...
    datePublished: '2026-03-01',
    dateModified: null,
    verdict: "Character.ai is the king of creative roleplay with fictional characters — but it's not trying to be an AI girlfriend app. No NSFW content, no photos, no voice, no relationship deepening. If you want to chat with anime characters or fictional personas, Character.ai is unmatched. If you want an actual AI girlfriend with intimacy, persistent memory, and a real connection, MyDreamGirlfriend.ai is built specifically for that.",
    features: [
      { feature: 'Purpose', us: 'AI girlfriend / relationship experience', them: 'Character roleplay / chat', winner: 'us' },
      { feature: 'Relationship Progression', us: 'Natural deepening with persistent memory', them: 'No relationship features', winner: 'us' },
      ...
      { feature: 'NSFW Content', us: 'Uncensored', them: 'Strictly SFW only', winner: 'us' },
      { feature: 'Privacy', us: 'End-to-end encryption', them: 'Standard', winner: 'us' },
      { feature: 'Free Tier', us: '15 messages/day, 1 girlfriend', them: 'Generous free access', winner: 'them' },
    ...
    faqs: [
      ...
      { question: 'Does Character.ai allow NSFW content?', answer: 'No. Character.ai has strict content filters and does not allow any NSFW, romantic, or adult content. MyDreamGirlfriend.ai offers fully uncensored content.' },
      { question: 'Can I create a girlfriend on Character.ai?', answer: "You can create characters, but Character.ai doesn't support girlfriend-specific features — no relationship deepening, no photos, no voice notes, and no romantic content." },
      ...
      { question: 'Why do people switch from Character.ai to MyDreamGirlfriend?', answer: "Primarily for the girlfriend experience — uncensored conversations, AI photos, voice notes, and a relationship that deepens naturally with persistent memory. Character.ai's SFW-only policy pushes users seeking more to platforms like MyDreamGirlfriend.ai." },
    ],
  },
];

export function getComparisonPagesLocal(): ComparisonPageAttributes[] {
  return comparisonPages;
}

export function getComparisonPageBySlugLocal(slug: string): ComparisonPageAttributes | null {
  return comparisonPages.find((p) => p.slug === slug) ?? null;
}
