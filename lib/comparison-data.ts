...
export const comparisonPages: ComparisonPageAttributes[] = [
  {
    ...
    faqs: [
      ...
      { question: 'Does MyDreamGirlfriend have a free plan like Candy AI?', answer: 'Yes. MyDreamGirlfriend.ai offers a free plan with 20 messages/day, 1 girlfriend, and access to all pre-built characters. No credit card required.' },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: 'Free Tier', us: '20 messages/day, 1 girlfriend', them: 'Generous free access', winner: 'them' },
