...
const faqs = [
  ...
  { question: 'Is roleplay content filtered?', answer: 'No. Roleplay is uncensored as your relationship deepens. Your conversations are private and encrypted. We don\'t impose content filters that limit your experience.' },
  ...
  { question: 'When does roleplay unlock?', answer: 'Roleplay is available as your relationship develops. More intimate roleplay scenarios unlock naturally as your connection deepens over time.' },
  ...
  return (
    ...
    >
      ...
      <ContentSection title="No Filters, No Limits">
        <p>
          Other AI apps hit you with content warnings the moment things get interesting. Not here. As your <Link href="/features" className="text-accent-purple hover:underline">relationship deepens</Link>, roleplay is completely uncensored. Your conversations are private, encrypted, and free from artificial content restrictions.
        </p>
        <p>
