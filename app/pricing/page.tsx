...
export const metadata = generateSEO({
  ...
  description: 'Simple, transparent pricing. Start free with no credit card required. Upgrade to Basic, Immersive, or Deep for unlimited messages, voice notes, AI photos & more.',
  path: '/pricing',
});
