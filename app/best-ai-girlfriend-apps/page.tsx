...
const faqs = [
  ...
  { question: 'Are AI girlfriend apps free?', answer: 'Most AI girlfriend apps offer free tiers with limited features. MyDreamGirlfriend.ai offers a free trial (5 messages + starter gems), Replika offers unlimited free chat, and most others have some free option. Premium plans range from $3.99 to $19.99/month depending on the platform.' },
